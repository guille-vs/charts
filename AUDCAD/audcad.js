...
function loadJSON(callback) {
  ...
  // xobj.open('GET', 'audcad.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
  xobj.open('GET', '/AUDCAD/audcad_td.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
  // xobj.open('GET', '/AUDCAD/audcad_tm.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
