...
//   xobj.open('GET', '/CHFJPY/tradermade.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
  xobj.open('GET', '/CHFJPY/twelvedata.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
