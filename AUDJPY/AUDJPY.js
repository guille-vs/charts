...
//   xobj.open('GET', '/AUDJPY/tradermade.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
  xobj.open('GET', '/AUDJPY/twelvedata.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
