...
//   xobj.open('GET', '/USDCAD/tradermade.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
  xobj.open('GET', '/USDCAD/twelvedata.json', true); // Reemplaza 'data.json' con la ruta de tu archivo JSON
